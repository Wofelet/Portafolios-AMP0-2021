...
int numeroAleatorio(int amx);
void papaCaliente(const vector<string> &listaNombres);

int main(){
	vector<string> jugadores = {"1.Erick", "2.Emmanuel", "3.Briam", "4.Gabriel", "5.Maria", "6.Oscar", "7.Krista", "8.Eduardo",
								"8.Eduardo", "9.Alejandra", "10.Carlos", "11.Diego", "12.Manuel", "13.Jose", "14.Mateo", "15.Fernando",
...
void papaCaliente(const vector<string> &listaNombres){
	...
	for(int i = cantidadJugadores; i > i; i--){
