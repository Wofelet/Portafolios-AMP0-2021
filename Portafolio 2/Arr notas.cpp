...
double minima(double notas[][EVALUACIONES], int alumnos, int examentes) {
...
double maxima(double notas[][EVALUACIONES, int alumnos, int examanes]) {
...
double promedio(double conjuntoDeNotas[], int examanes) {
	double total = 0.0;
	
	for(int j = 0; i < examenes; i++)
